          ...
          <div className="container mx-auto px-margin-desktop max-w-container-max">
            <div className="bg-inverse-surface rounded-[40px] p-12 md:p-24 text-center text-white">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button onClick={() => navigate('/register')} className="bg-primary text-on-primary px-10 py-5 rounded-xl font-bold text-lg hover:bg-primary-container transition-all">Start For Free</button>
